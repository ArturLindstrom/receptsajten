...
const StyledHeader = styled.header`
    ...
    height: 30rem;
    margin: 0 auto;
    background: url("https://images.unsplash.com/photo-1608679627227-543290e0eb76?crop=entropy&cs=tinysrgb&fm=jpg&ixlib=rb-1.2.1&q=80&raw_url=true&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070")
        no-repeat;
